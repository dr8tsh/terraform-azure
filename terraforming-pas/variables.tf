...
variable cf_storage_account_name {
  type        = "string"
  description = "storage account name for pcf"
  default     = "pcf"
}

variable cf_buildpacks_storage_container_name {
  type        = "string"
  description = "container name for pcf buildpacks"
  default     = "buildpacks"
}

variable cf_packages_storage_container_name {
  type        = "string"
  description = "container name for pcf packages"
  default     = "packages"
}

variable cf_droplets_storage_container_name {
  type        = "string"
  description = "container name for pcf droplets"
  default     = "droplets"
}

variable cf_resources_storage_container_name {
  type        = "string"
  description = "container name for pcf resources"
  default     = "resources"
}
